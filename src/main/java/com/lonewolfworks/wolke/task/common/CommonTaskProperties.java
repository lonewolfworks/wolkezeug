 ...
 */
package com.lonewolfworks.wolke.task.common;
...
public class CommonTaskProperties {
    ...
    private String iamDefaultRolePath;

    public String getIamDefaultRolePath() {
		return iamDefaultRolePath;
	}

	public void setIamDefaultRolePath(String iamDefaultRolePath) {
		this.iamDefaultRolePath = iamDefaultRolePath;
	}
