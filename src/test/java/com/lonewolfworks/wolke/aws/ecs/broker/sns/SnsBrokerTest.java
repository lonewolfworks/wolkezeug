...
public class SnsBrokerTest {
    ...
    public void brokerTopicTopicAttribute() throws Exception {
        ...
        verify(client, times(13)).setTopicAttributes(any(SetTopicAttributesRequest.class));
    }
    ...
    private Map<String, String> getPossibleDeliveryAttributeNameValueMap() {
        ...
        possibleDeliveryAttributeNameValueMap.put("SQSSuccessFeedbackRoleArn", "arn:aws:iam::111111:role/SNSSuccessFeedback");
        possibleDeliveryAttributeNameValueMap.put("SQSSuccessFeedbackSampleRate", "100");
        possibleDeliveryAttributeNameValueMap.put("SQSFailureFeedbackRoleArn", "arn:aws:iam::111111:role/SNSFailureFeedback");
