...
public class DdosWafBrokerClient {

    private HermanLogger buildLogger;
    private AWSLambda lambdaClient;

    public DdosWafBrokerClient(HermanLogger buildLogger, AWSLambda lambdaClient) {
        this.buildLogger = buildLogger;
        this.lambdaClient = lambdaClient;
    }

    public void brokerDDoSWAFConfiguration(String appName, String elbArn, DdosWafBrokerProperties brokerConfiguration) {
        ...
        try {
            DdosWafBrokerRequest request = new DdosWafBrokerRequest()
                ...
                .withWafConfiguration(brokerConfiguration.getWafConfiguration());
