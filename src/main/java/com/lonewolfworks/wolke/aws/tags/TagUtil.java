 ...
 */
package com.lonewolfworks.wolke.aws.tags;
...
public class TagUtil {
    ...
    public static List<com.amazonaws.services.secretsmanager.model.Tag> hermanToSecretsManagerTags(List<HermanTag> tags) {
        return tags.stream().map(HermanTag::toSecretsManagerTag).collect(Collectors.toList());
    }
