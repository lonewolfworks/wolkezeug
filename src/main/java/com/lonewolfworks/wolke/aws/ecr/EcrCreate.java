 ...
 */
package com.lonewolfworks.wolke.aws.ecr;
...
import com.amazonaws.services.ecr.model.ImageScanningConfiguration;
...
public class EcrCreate {
    ...
    public String createRepo(String name) {
        ...
        client.putImageScanningConfiguration(new PutImageScanningConfigurationRequest()
        					.withImageScanningConfiguration(new ImageScanningConfiguration().withScanOnPush(true))
        					.withRepositoryName(repo.getRepositoryName())
        					.withRegistryId(repo.getRegistryId()));
        client.putImageTagMutability(new PutImageTagMutabilityRequest()
        					.withRepositoryName(repo.getRepositoryName())
